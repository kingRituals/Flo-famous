      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-700 text-xs font-semibold border border-slate-200 transition-colors"
          ...
          {isRoleDropdownOpen && (
            <div
              ...
              className="absolute right-0 top-full mt-2 w-64 bg-white border border-slate-200 rounded-2xl shadow-xl py-2 z-50 text-xs"
            >
              {/* Profile Summary */}
              ...
              <div className="mt-2 pt-2 border-t border-slate-100 px-2">
                <button
                  ...
                  className="w-full px-3 py-2 text-left hover:bg-rose-50 text-rose-700 rounded-xl font-bold flex items-center gap-2 text-xs transition-colors cursor-pointer"
                >
